...
final public class plotCircuitFinal
{
  ...
  public static final int dataIncrement = 20; //every dataIncrement data points were be printed in the output file
  ...
  public static void main(String t[])
  {
    ...
    try
    {
      s = new double[(int)(4*circuitLength/separationDistance + 4*circuitHeight/separationDistance)][N/dataIncrement]; //defining the lengths of the 2D position array --> notice the dataIncrement + 1 term in the length since, after the complete position data for a given charge, there is a newline character
