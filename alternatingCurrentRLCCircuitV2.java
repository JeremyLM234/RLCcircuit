...
public class alternatingCurrentRLCCircuitV2
{
  ...
  public static final double Imax = 70.; //maximum current of the source in charges/s
  ...
  public static final double dataIncrement = 10; //every dataIncrement data points will be printed in the output file, this increment will need to be used in the plotCircuit code as well
